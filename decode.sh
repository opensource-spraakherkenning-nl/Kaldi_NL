...
lexicon='models/NL/UTwente/HMI/Lexicon/lexicon.lex(251k)'
lmodel=models/NL/UTwente/HMI/LM/KrantenTT/v1.0/KrantenTT.3gpr.kn.int.arpa.gz
lpath=models/NL/UTwente/HMI/LM/KrantenTT/v1.0/LG_KrantenTT.3gpr.kn.int_UTwente_HMI_lexicon
llmodel=models/NL/UTwente/HMI/LM/KrantenTT/v1.0/KrantenTT.4gpr.kn.int.arpa.gz
llpath=models/NL/UTwente/HMI/LM/KrantenTT/v1.0/LG_KrantenTT.3gpr.kn.int_UTwente_HMI_lexicon/Const_UTwente_HMI_KrantenTT_v1.0_KrantenTT.4gpr.kn.int
extractor=
...
if [ $stage -le 7 ]; then
	...
	eval $timer steps/online/nnet3/decode.sh --nj $this_nj --acwt 1.2 --post-decode-acwt 10.0 --skip-scoring true models/NL/UTwente/HMI/AM/CGN_all/nnet3_online/tdnn/v1.0/graph_UTwente_HMI_KrantenTT_v1.0_KrantenTT.3gpr.kn.int_UTwente_HMI_lexicon $data/ALL $tmp >>$logging 2>&1 &
	pid=$!
